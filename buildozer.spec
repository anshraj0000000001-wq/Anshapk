...
# Note: 'requests' is added here as it's used in your main.py
...
# (list) Permissions
# Necessary for accessing /storage/emulated/0/Pictures
...
# This can be useful to avoid any surprises
